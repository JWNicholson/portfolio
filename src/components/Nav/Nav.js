    ...
    <ul class="menu">
        ...
        <li class="nav-item has-submenu">
            ...
            <ul class="nav-submenu">
                <li class="nav-subitem"><a href="/">Conway's Game Of Life</a></li>
                <li class="nav-subitem"><a href="/">NASA pic of the day</a></li>
                <li class="nav-subitem"><a href="/">Prisoner Skills</a></li>
            </ul>
        </li>
